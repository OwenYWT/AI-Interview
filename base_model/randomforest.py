...
# 训练并保存模型
train_and_save_model(X, df['Overall'], 'data/y_overall_model.joblib')
train_and_save_model(X, df['RecommendHiring'], 'data/y_recommend_hiring_model.joblib')
train_and_save_model(X, df['StructuredAnswers'], 'data/y_structured_answers_model.joblib')